 ...
 */
export declare function isWithinAny(bases: readonly string[], target: string, platform?: NodeJS.Platform): boolean;
/**
 ...
 */
export declare function uniqueRoots(cwd: string, folders?: readonly string[]): string[];
